...
public class BlueAllianceParkObservation extends LinearOpMode {
    ...
    public void driveStrafeLeft(double power, double distance) {
        //reset encoders
        robot.backLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.backRightDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.frontLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public void driveStrafeRight(double power, double distance) {
        //reset encoders
        robot.backLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.backRightDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.frontLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        //set target position
        //negate this part to switch direction/strafe
        robot.backLeftDrive.setTargetPosition(-encoderTarget);
        robot.backRightDrive.setTargetPosition(encoderTarget);
        robot.frontLeftDrive.setTargetPosition(encoderTarget);
        robot.frontRightDrive.setTargetPosition(-encoderTarget);
    ...
    public void driveReverse(double power, double distance) {
        //reset encoders
        robot.backLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.backRightDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.frontLeftDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
